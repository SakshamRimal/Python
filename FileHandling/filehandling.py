...
# --------- better way of using file handling is by using with---------


with open("example1" , 'w+') as file1:
    # here example1 is a text file created and file1 is a variable whenever we want to use a variable we use file1
